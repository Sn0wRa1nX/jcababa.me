        ...
        <div className="md:col-span-1">
          <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
            ...
            <div className="flex flex-col space-y-2">
              <Link
                href="#"
                className="inline-block px-4 py-2 bg-pink-500 text-white rounded-full hover:bg-pink-600 transition-colors duration-300 text-center"
              >
                Download Full Resume
              </Link>
              <Link
                href="#"
                className="inline-block px-4 py-2 bg-purple-500 text-white rounded-full hover:bg-purple-600 transition-colors duration-300 text-center"
              >
