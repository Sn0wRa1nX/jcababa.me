...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className={`${oswald.variable} ${poppins.variable} font-sans min-h-screen flex flex-col select-none`}>
        <ThemeProvider>
          <PreventRightClick />
          ...
          <footer className="py-6 px-4 md:px-6 bg-background">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6">
                {/* Social Icons */}
                <a href="#" className="group" draggable="false">
                  <svg
                    className="w-6 h-6 text-black dark:text-white group-hover:text-pink-500 transition-colors duration-300"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
                ...
                <a href="#" className="group" draggable="false">
                  <span className="font-bold text-sm px-2 py-1 border border-black dark:border-white text-black dark:text-white group-hover:text-pink-500 group-hover:border-pink-500 transition-colors duration-300 rounded-md">
                    OJ.ph
                  </span>
                </a>
              </div>
