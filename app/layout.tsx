            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6">
                ...
                <SocialIcon href="#" label="Facebook">
                  <svg
                    className="w-6 h-6 text-black dark:text-white group-hover:text-pink-500 transition-colors duration-200"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                    aria-hidden="true"
                  >
                ...
                <SocialIcon href="#" label="Online Jobs PH">
                  <span className="font-bold text-sm px-2 py-1 border border-black dark:border-white text-black dark:text-white group-hover:text-pink-500 group-hover:border-pink-500 transition-colors duration-200 rounded-md">
                    OJ.ph
                  </span>
                </SocialIcon>
              </div>
