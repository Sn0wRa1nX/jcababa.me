    ...
    <html lang="en" suppressHydrationWarning>
      <body className={`${oswald.variable} ${poppins.variable} font-sans min-h-screen flex flex-col`}>
        <ThemeProvider>
          ...
          <footer className="py-6 px-4 md:px-6 bg-background border-t border-border">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6">
                <a href="#" className="text-foreground/80 hover:text-pink-500 transition-colors duration-300">
                ...
                <a href="#" className="text-foreground/80 hover:text-pink-500 transition-colors duration-300">
                  <span className="font-bold text-sm px-2 py-1 border rounded-md">OJ.ph</span>
                </a>
              </div>
            </div>
          </footer>
