    ...
    <html lang="en">
      <body className={inter.className}>
        <header className="flex justify-between items-center p-4 md:p-6">
          <Link
            href="/"
            className="text-2xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500"
          >
            SnowRainX
          </Link>
          <nav className="hidden md:flex space-x-8">
            ...
            <Link href="/portfolio" className="text-gray-800 hover:text-pink-500 transition-colors duration-300">
              Portfolio
            </Link>
        ...
        <main>{children}</main>
        <footer className="mt-20 flex flex-col md:flex-row justify-between items-center border-t pt-8 px-4 md:px-6">
